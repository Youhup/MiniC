...
public class PointerType implements Type {
	...
	public boolean equalsTo(Type _other) {
		if (_other instanceof PointerType){
			PointerType _otherP = (PointerType) _other;
			return this.element.equalsTo(_otherP.getPointedType());
		}else {
			return false;
		}
	...
	public boolean compatibleWith(Type _other) {
		if (_other instanceof PointerType){
			PointerType _otherP = (PointerType) _other;
			return this.element.compatibleWith(_otherP.getPointedType()); // quel ordre choisir !!
		}else {
			return false;
		}
	}
