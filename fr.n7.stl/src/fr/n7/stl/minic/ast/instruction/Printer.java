...
public class Printer implements Instruction {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		}else if (typeParametre.equalsTo(AtomicType.BooleanType)) {
			fragment.add(Library.BOut);
			
		}else if (typeParametre.equalsTo(AtomicType.CharacterType)) {
			fragment.add(Library.COut);
			
		}else if (typeParametre.equalsTo(AtomicType.StringType)) {
