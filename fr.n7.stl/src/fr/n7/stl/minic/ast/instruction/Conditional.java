...
public class Conditional implements Instruction {
	...
	public boolean collectAndPartialResolve(HierarchicalScope<Declaration> _scope) {
        ...
        ok &= this.thenBranch.collectAndPartialResolve(ThenScope);
		if (this.elseBranch != null) {
			SymbolTable ElseScope = new SymbolTable(_scope);
			ok &= this.elseBranch.collectAndPartialResolve(ElseScope);
		} 
        return ok;
	}
	...
	public boolean completeResolve(HierarchicalScope<Declaration> _scope) {
    	...
    	SymbolTable ThenScope = new SymbolTable(_scope);
        ok &= this.thenBranch.completeResolve(ThenScope);
		if (this.elseBranch != null) {
			SymbolTable ElseScope = new SymbolTable(_scope);
			ok &= this.elseBranch.completeResolve(ElseScope);
		} 
        return ok;
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		String FinIfLabel = "fin"  + labelnumber;
		String elseLabel = "else_" + labelnumber;
